...
export async function seedDemoActivity(
  ...
  const rows: {
    ...
    },
    {
      ...
      metadata: { amount: 5000, entity_type: 'expense', message: 'Usman created Food Expense for PKR 5,000' },
    ...
    },
    {
      ...
      metadata: { amount: 5000, shared: true, entity_type: 'expense', message: 'Ahmed submitted Food Expense for PKR 5,000' },
    ...
    },
    {
      ...
      metadata: { amount: 5000, entity_type: 'expense', message: 'Usman approved Food Expense for PKR 5,000' },
    ...
    },
    {
      ...
      metadata: { amount: 7800, entity_type: 'expense', message: 'Usman updated Office Expense to PKR 7,800' },
      created_at: toIso(daysAgo(2)),
    },
    {
      team_id: hq.id,
    ...
    },
    {
      ...
      metadata: { amount: 1500, entity_type: 'expense', message: 'Usman deleted Miscellaneous Expense for PKR 1,500' },
    ...
    },
    {
      ...
      metadata: { amount: 900, entity_type: 'settlement', message: 'Settlement cancelled for PKR 900' },
    ...
    },
    {
      ...
      metadata: { type: 'monthly', amount: 10000, entity_type: 'budget', message: 'Budget deleted for PKR 10,000' },
