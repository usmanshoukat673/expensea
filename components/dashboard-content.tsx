            ...
            >
              <Card className="hover-lift soft-shadow">
                ...
                <CardContent>
                  ...
                  <p className={`text-xs mt-1 ${stat.className ?? 'text-muted-foreground'}`}>
                    {stat.sub}
                  </p>
                </CardContent>
              </Card>
            ...
            {recentEntries.length === 0 ? (
              ...
              <div className="space-y-3">
                {recentEntries.map((entry) => (
                  ...
                  >
                    <div>
                      <p className="font-medium">{entry.profiles?.full_name ?? 'Member'}</p>
              ...
              {leaderboard.length === 0 ? (
                ...
                leaderboard.map((row, i) => (
                  <div key={row.userId} className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold">{format(row.total)}</span>
                  </div>
                ))
              )}
            </CardContent>
